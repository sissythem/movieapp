...
![Maven archetype for EAR Project](./earProjectCreation.JPG)
...
![Maven archetype for Vaadin Project](./vaadinProject.JPG)
...
![Change Java version to pom.xml - External Project](./pomJavaVersion.JPG)
...
![The arquillian.xml file](./arquillian.JPG)
...
![The test-ds.xml file](./test-ds.JPG)

![The test-persistence.xml file](./test-persistence.JPG)
...
![The MyDeployment.java file](./deployment.JPG)
