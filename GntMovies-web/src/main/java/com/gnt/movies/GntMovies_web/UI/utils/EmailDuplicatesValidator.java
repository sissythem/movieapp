...
public class EmailDuplicatesValidator implements Validator<String> {
	...
	public EmailDuplicatesValidator(String errorMessage, UserForm userForm) {
	...
	public ValidationResult apply(String value, ValueContext context) {
		...
		if (selectedUser == null) {
			...
			if (userBean.emailExists(value) &&
					selectedUser.getId() != userBean.getUserByEmail(value).getId()) {
				return ValidationResult.error(errorMessage);
			} else {
				return ValidationResult.ok();
			}
